...
public class ExPrayer {
	...
	public enum Equipment {
		...
		BROODOO_SHIELD(new int[] { 6279, 6277, 6275, 6273, 6271, 6269, 6267, 6265, 6263, 6261, 6259, 6257, 6255, 6253,
				6251, 6249, 6247, 6245, 6243, 6241, 6239, 6237, 6235, 6233, 6231, 6229, 6227, 6225, 6223, 6221, 6219,
				6217, 6215 }, 5),
		GOD_BOOKS(new int[] { 3839, 3840, 3841, 3842, 3843, 3844, 19612, 19613, 19614, 19615, 19615, 19617 }, 5),
		FAITHFUL_SHIELD(18747, 6),
		WHITE_SQ_SHIELD(6631, 1),
		WHITE_KITE_SHIELD(6633, 1),
		AMULET_OF_POWER(1731, 1),
		AMULET_OF_GLORY(new int[] { 1704, 1706, 1708, 1710, 1712, 10362, 10360, 10358, 10356, 10354 }, 3),
		...
		GOD_ROBE_BOTTOM(new int[] { 10466, 10464, 10468, 19390, 19386, 19388 }, 4),
		...
		CAPES_OF_ACHIEVEMENTS_TRIMMED(new int[] { 9748, 9751, 9754, 9757, 9760, 9763, 9766, 9769, 9772, 9775, 9778,
				9781, 9784, 9787, 9790, 9793, 9796, 9799, 9802, 9805, 9808, 9811, 9949, 12170, 18509 }, 4),
		THIRD_AGE_DRUIDIC_CLOAK(19311, 6),
		MAX_CAPE(new int[] { 20747, 20767 }, 10),
		SOUL_WARS_CAPE(new int[] { 14641, 14642, 14645, 15432, 15433, 15434, 15435, 15474 }, 12),
		...
		IVANDIS_FLAIL(new int[] { 13117, 13118, 13119, 13120, 13121, 13122, 13123, 13124, 13125, 13126, 13127, 13128,
				13129, 13130, 13131, 13132, 13133, 13134, 13135, 13136, 13137, 13138, 13139, 13140, 13141, 13142,
				13143, 13144, 13145, 13146 }, 5),
		...
		ROLLING_PIN(7445, 4),
		WHITE_DAGGER_SWORD_LONGSWORD_WARHAMMER_BATTLEAXE_SCIMMY_CLAWS_2H_HALBERD_STAFF(new int[] { 6591, 6599, 6609,
				6589, 6587, 6593, 6595, 6597, 6607, 6603, 6611, 6605, 6613 }, 1),
		RUNE_CANE(13099, 4),
		ADDY_CANE(13097, 3),
		BLACK_CANE(13095, 2);
